...
<body id="back">
	<div align="center" id="main" style="padding-top: 35px;">
		<div class="login_logo" >
			<span id="denglu" style="font-size: 30px;"><a style='text-decoration:none;' href="Staffregister.jsp">客&nbsp;&nbsp;户
				&nbsp;&nbsp;注&nbsp;&nbsp;册</a></span>
		</div>
		<form action="http://localhost:8080/EnterpriseManager/register"
			method="post">
			<table border=1>
				<tr>
					<td>用户名</td>
				...
				<tr>
					...
					<td><input class="easyui-linkbutton"
						...
						&nbsp;&nbsp;
						<a  style="text-decoration:none;" href="http://localhost:8080/EnterpriseManager/index.jsp">返回登录</a>
					</td>
				</tr>
				<tr></tr>
				<tr height="20">
