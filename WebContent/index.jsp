...
<body id="main">
	...
	<div align="center" style="padding-top: 35px;">
		<div class="login_logo">
	              <span id="register" style="font-size: 30px; "><a href="staffLogin.jsp" style='text-decoration:none;'>用&nbsp;&nbsp;户&nbsp;&nbsp;登&nbsp;&nbsp;录</a></span>
	    </div>
			...
			<table align="center" width="500" height="400">
				...
				<tr height="20">
					...
					<td width="10%"><input type="text" class="easyui-textbox" style="width:200px;height: 35px" value="${userName }" name="userName"
						id="userName"></td>
						<td ><input type="button" id="re" class="easyui-linkbutton" value="注册"   style="width:80px;height: 25px;" onclick="javascript:window.location.href='register/register.jsp'"></td>
					<td width="30%"></td>
				</tr>
				<tr height="30"></tr>
				<tr height="20">
